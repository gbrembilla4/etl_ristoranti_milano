# Stima Calorie e Allergeni per Piatti Milano 
...
def main():
    ...
    # === Deduplicazione Piatti (Fuzzy Matching) con Cache ===
    # La cache viene creata DOPO tutti i filtri
